...
describe JavaBuildpack::Container::TomeeInstance do
  include_context 'component_helper'

  let(:component_id) { 'tomee' }

  it 'always detects' do
    expect(component.detect).to eq("tomee-instance=#{version}")
  end
  ...
  context do
    ...
    it 'links only the application files and directories to the first-segment#second-segment webapp',
      ...
      root_webapp = app_dir + '.java-buildpack/tomee/webapps/first-segment#second-segment'
